...
pub use app::{
    CheckOptions, CheckResult, ComparisonOptions, ComparisonReceipt, EvaluationOptions,
    EvaluationReceipt, InspectionOptions, InspectionResult, check, compare, evaluate, inspect,
};
